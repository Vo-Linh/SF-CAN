# DeepLabV3+ R101 + VIB + Confidence-Aware
_base_ = [
    '../_base_/default_runtime.py',
    '../_base_/models/deeplabv3plus_r101_vib.py',
...
name = 'R2U_5percent_smda_emd_deeplabv3plus_r101_vib'
exp = 'ablation_deeplabv3plus'
name_dataset = 'rural2urban'
name_architecture = 'deeplabv3plus_r101_vib'
name_encoder = 'r101'
name_decoder = 'deeplabv3plus_vib'
name_uda = 'smda_emd'
