# UNetFormer R18 + VIB + Confidence-Aware
_base_ = [
    '../_base_/default_runtime.py',
    '../_base_/models/unetformer_r18_vib.py',
...
name = 'R2U_5percent_smda_emd_unetformer_r18_vib'
exp = 'ablation_unetformer'
name_dataset = 'rural2urban'
name_architecture = 'unetformer_r18_vib'
name_encoder = 'swsl_resnet18'
name_decoder = 'unetformer_vib'
name_uda = 'smda_emd'
